...
namespace ECommerceWebSite.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            return View("~/Views/Home/User/UserCreate.cshtml");
        }

        [HttpPost]
        public async Task<IActionResult> UserCreate(UserExtendedModel model)
        {
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            return View("~/Views/Home/User/UserEdit.cshtml", model);
        }
